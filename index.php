...
<head>
    ...
    <title>AIC Fashion | Toko Fashion Wanita Modern Terpercaya</title>
    <!-- Font Awesome 6 -->
...
<footer>
    <div class="footer-container">
        <div>
            <h3><i class="fa-solid fa-store"></i> AIC Fashion</h3>
    ...
    <div class="footer-bottom">
        © 2026 AIC Fashion. All Rights Reserved. | Belanja fashion wanita mudah & aman.
    </div>
</footer>
